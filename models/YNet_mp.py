...
class YNet_mp(nn.Module):
    def __init__(self, in_channel, n_classes=1):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(YNet_mp, self).__init__()
        ...
        self.dc8 = self.conv_block(512 + 256, 128, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.dc5 = self.conv_block(256 + 128, 64, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.dc2 = self.conv_block(128 + 64, 32, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def forward(self, a, b,c,d):
        ...
        # Shared decoder
        d9 = torch.cat((self.dc9(e7), syn2_a, syn2_b, syn2_c, syn2_d), dim=1)
        del e7, syn2_a, syn2_b, syn2_c, syn2_d
        d8 = self.dc8(d9)
        d7 = self.dc7(d8)
        del d9, d8

        d6 = torch.cat((self.dc6(d7), syn1_a, syn1_b, syn1_c, syn1_d), dim=1)
        del d7, syn1_a, syn1_b, syn1_c, syn1_d

        d5 = self.dc5(d6)
        d4 = self.dc4(d5)
        del d6, d5

        d3 = torch.cat((self.dc3(d4), syn0_a, syn0_b, syn0_c, syn0_d), dim=1)
        del d4, syn0_a, syn0_b, syn0_c, syn0_d
