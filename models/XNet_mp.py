...
class XNet_mp(nn.Module):
    def __init__(self, in_channel, n_classes=1):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(XNet_mp, self).__init__()
        ...
        self.final_seg = self.finalLayer(32, n_classes, kernel_size=1, stride=1, bias=False)
        ...
        self.final_det = self.finalLayer(32, n_classes, kernel_size=1, stride=1, bias=False)
...
#        print((self.dc9_seg(e7).shape, syn2_a.shape, syn2_b.shape, syn2_c.shape))
        ...
        d0_det = self.final_det(d1_det)
        return d0_seg, d0_det