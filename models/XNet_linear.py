...
class XNet_linear(nn.Module):
    def __init__(self, in_channel, n_classes=1):
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(XNet_linear, self).__init__()
        ...
        self.final_a = self.finalLayer(32, n_classes, kernel_size=1, stride=1, bias=False)
