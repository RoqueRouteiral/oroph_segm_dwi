...
from tools.loader_double_gt_mp import get_loaders_xnet
from tools.loader_double_gt_mp_detection import get_loaders_xnet_linear
...
def main(yaml_filepath):
    ...
    if cf['model_name'] == 'xnet' or cf['model_name'] == 'xnet_mp':
            train_gen, val_gen, test_gen = get_loaders_xnet(cf)
    elif (cf['model_name'] == 'xnet_linear') or (cf['model_name'] == 'det_u'):
            train_gen, val_gen, test_gen = get_loaders_xnet_linear(cf)
    elif cf['second_stage'] and not cf['box_prediction']:
